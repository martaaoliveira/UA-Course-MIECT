...
-- m[3]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- valid	=>  Location: PIN_K21,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- y[4]	=>  Location: PIN_M20,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \ALT_INV_f_check~0_combout\ : std_logic;
SIGNAL \d_2|ALT_INV_y~0_combout\ : std_logic;
SIGNAL \d_1|ALT_INV_y~0_combout\ : std_logic;
SIGNAL \m_2|ALT_INV_y~combout\ : std_logic;
SIGNAL \m2isOne|m_onef|ALT_INV_y~0_combout\ : std_logic;
...
\ALT_INV_f_check~0_combout\ <= NOT \f_check~0_combout\;
\d_2|ALT_INV_y~0_combout\ <= NOT \d_2|y~0_combout\;
\d_1|ALT_INV_y~0_combout\ <= NOT \d_1|y~0_combout\;
\m_2|ALT_INV_y~combout\ <= NOT \m_2|y~combout\;
\m2isOne|m_onef|ALT_INV_y~0_combout\ <= NOT \m2isOne|m_onef|y~0_combout\;
...
-- Equation(s):
-- \xorc23|y~combout\ = ( !\y[7]~input_o\ & ( \y[3]~input_o\ ) ) # ( \y[7]~input_o\ & ( !\y[3]~input_o\ ) )
...
-- Equation(s):
-- \xorc22|y~combout\ = ( \y[6]~input_o\ & ( !\y[2]~input_o\ ) ) # ( !\y[6]~input_o\ & ( \y[2]~input_o\ ) )
...
-- Equation(s):
-- \m2isOne|m_Error|y~0_combout\ = ( \y[4]~input_o\ & ( (!\xorc23|y~combout\ & ((!\y[0]~input_o\ & (!\xorc22|y~combout\ $ (!\xorc21|y~combout\))) # (\y[0]~input_o\ & (\xorc22|y~combout\ & \xorc21|y~combout\)))) # (\xorc23|y~combout\ & ((!\y[0]~input_o\ & 
-- (!\xorc22|y~combout\ & !\xorc21|y~combout\)) # (\y[0]~input_o\ & (!\xorc22|y~combout\ $ (!\xorc21|y~combout\))))) ) ) # ( !\y[4]~input_o\ & ( (!\xorc23|y~combout\ & ((!\y[0]~input_o\ & (\xorc22|y~combout\ & \xorc21|y~combout\)) # (\y[0]~input_o\ & 
-- (!\xorc22|y~combout\ $ (!\xorc21|y~combout\))))) # (\xorc23|y~combout\ & ((!\y[0]~input_o\ & (!\xorc22|y~combout\ $ (!\xorc21|y~combout\))) # (\y[0]~input_o\ & (!\xorc22|y~combout\ & !\xorc21|y~combout\)))) ) )
...
-- Equation(s):
-- \xorc02|y~combout\ = ( !\y[5]~input_o\ & ( \y[4]~input_o\ ) ) # ( \y[5]~input_o\ & ( !\y[4]~input_o\ ) )
...
-- Equation(s):
-- \xorc01|y~combout\ = !\y[2]~input_o\ $ (!\y[3]~input_o\)
...
-- Equation(s):
-- \xorc13|y~combout\ = !\y[7]~input_o\ $ (!\y[5]~input_o\)
...
-- Equation(s):
-- \m1isOne|m_Error|y~0_combout\ = ( \y[0]~input_o\ & ( (!\y[2]~input_o\ & ((!\xorc13|y~combout\ & (!\xorc12|y~combout\ $ (!\xorc11|y~combout\))) # (\xorc13|y~combout\ & (!\xorc12|y~combout\ & !\xorc11|y~combout\)))) # (\y[2]~input_o\ & ((!\xorc13|y~combout\ 
-- & (\xorc12|y~combout\ & \xorc11|y~combout\)) # (\xorc13|y~combout\ & (!\xorc12|y~combout\ $ (!\xorc11|y~combout\))))) ) ) # ( !\y[0]~input_o\ & ( (!\y[2]~input_o\ & ((!\xorc13|y~combout\ & (\xorc12|y~combout\ & \xorc11|y~combout\)) # (\xorc13|y~combout\ & 
-- (!\xorc12|y~combout\ $ (!\xorc11|y~combout\))))) # (\y[2]~input_o\ & ((!\xorc13|y~combout\ & (!\xorc12|y~combout\ $ (!\xorc11|y~combout\))) # (\xorc13|y~combout\ & (!\xorc12|y~combout\ & !\xorc11|y~combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001011001101000000101100110100000101001100101000010100110010100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_y[2]~input_o\,
	datab => \xorc13|ALT_INV_y~combout\,
	datac => \xorc12|ALT_INV_y~combout\,
	datad => \xorc11|ALT_INV_y~combout\,
...
-- Equation(s):
-- \m_0|y~combout\ = ( \xorc00|y~combout\ & ( !\m1isOne|m_Error|y~0_combout\ & ( (!\m2isOne|m_Error|y~0_combout\ & ((!\xorc02|y~combout\ & (\xorc03|y~combout\ & \xorc01|y~combout\)) # (\xorc02|y~combout\ & ((\xorc01|y~combout\) # (\xorc03|y~combout\))))) ) ) 
-- ) # ( !\xorc00|y~combout\ & ( !\m1isOne|m_Error|y~0_combout\ & ( (!\m2isOne|m_Error|y~0_combout\ & (\xorc02|y~combout\ & (\xorc03|y~combout\ & \xorc01|y~combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \m2isOne|m_Error|ALT_INV_y~0_combout\,
	datab => \xorc02|ALT_INV_y~combout\,
	datac => \xorc03|ALT_INV_y~combout\,
	datad => \xorc01|ALT_INV_y~combout\,
	datae => \xorc00|ALT_INV_y~combout\,
...
-- Equation(s):
-- \m0isOne|m_Error|y~0_combout\ = ( \xorc01|y~combout\ & ( (!\xorc02|y~combout\ & (!\xorc03|y~combout\ $ (!\xorc00|y~combout\))) # (\xorc02|y~combout\ & (!\xorc03|y~combout\ & !\xorc00|y~combout\)) ) ) # ( !\xorc01|y~combout\ & ( (!\xorc02|y~combout\ & 
-- (\xorc03|y~combout\ & \xorc00|y~combout\)) # (\xorc02|y~combout\ & (!\xorc03|y~combout\ $ (!\xorc00|y~combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001100111100000000110011110000111100110000000011110011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \xorc02|ALT_INV_y~combout\,
	...
	dataf => \xorc01|ALT_INV_y~combout\,
	combout => \m0isOne|m_Error|y~0_combout\);

-- Location: LABCELL_X88_Y37_N21
\m1isOne|m_onef|y~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \m1isOne|m_onef|y~0_combout\ = ( \y[0]~input_o\ & ( (!\y[2]~input_o\ & ((!\xorc13|y~combout\ & (\xorc12|y~combout\ & \xorc11|y~combout\)) # (\xorc13|y~combout\ & ((\xorc11|y~combout\) # (\xorc12|y~combout\))))) # (\y[2]~input_o\ & (\xorc13|y~combout\ & 
-- (\xorc12|y~combout\ & \xorc11|y~combout\))) ) ) # ( !\y[0]~input_o\ & ( (!\y[2]~input_o\ & (\xorc13|y~combout\ & (\xorc12|y~combout\ & \xorc11|y~combout\))) # (\y[2]~input_o\ & ((!\xorc13|y~combout\ & (\xorc12|y~combout\ & \xorc11|y~combout\)) # 
-- (\xorc13|y~combout\ & ((\xorc11|y~combout\) # (\xorc12|y~combout\))))) ) )
...
-- Equation(s):
-- \m_1|y~combout\ = ( !\m1isOne|m_Error|y~0_combout\ & ( (!\m0isOne|m_Error|y~0_combout\ & (!\m2isOne|m_Error|y~0_combout\ & \m1isOne|m_onef|y~0_combout\)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \m0isOne|m_Error|ALT_INV_y~0_combout\,
	datac => \m2isOne|m_Error|ALT_INV_y~0_combout\,
	datad => \m1isOne|m_onef|ALT_INV_y~0_combout\,
	dataf => \m1isOne|m_Error|ALT_INV_y~0_combout\,
	combout => \m_1|y~combout\);

-- Location: LABCELL_X88_Y37_N36
\m2isOne|m_onef|y~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \m2isOne|m_onef|y~0_combout\ = ( \y[0]~input_o\ & ( (!\xorc23|y~combout\ & (!\y[4]~input_o\ & (\xorc22|y~combout\ & \xorc21|y~combout\))) # (\xorc23|y~combout\ & ((!\y[4]~input_o\ & ((\xorc21|y~combout\) # (\xorc22|y~combout\))) # (\y[4]~input_o\ & 
-- (\xorc22|y~combout\ & \xorc21|y~combout\)))) ) ) # ( !\y[0]~input_o\ & ( (!\xorc23|y~combout\ & (\y[4]~input_o\ & (\xorc22|y~combout\ & \xorc21|y~combout\))) # (\xorc23|y~combout\ & ((!\y[4]~input_o\ & (\xorc22|y~combout\ & \xorc21|y~combout\)) # 
-- (\y[4]~input_o\ & ((\xorc21|y~combout\) # (\xorc22|y~combout\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100010111000000010001011100000100010011010000010001001101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \xorc23|ALT_INV_y~combout\,
	...
	datad => \xorc21|ALT_INV_y~combout\,
	dataf => \ALT_INV_y[0]~input_o\,
	combout => \m2isOne|m_onef|y~0_combout\);

-- Location: LABCELL_X88_Y37_N33
\m_2|y\ : cyclonev_lcell_comb
-- Equation(s):
-- \m_2|y~combout\ = ( !\m1isOne|m_Error|y~0_combout\ & ( (\m2isOne|m_onef|y~0_combout\ & (!\m0isOne|m_Error|y~0_combout\ & !\m2isOne|m_Error|y~0_combout\)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \m2isOne|m_onef|ALT_INV_y~0_combout\,
	datac => \m0isOne|m_Error|ALT_INV_y~0_combout\,
	datad => \m2isOne|m_Error|ALT_INV_y~0_combout\,
	dataf => \m1isOne|m_Error|ALT_INV_y~0_combout\,
...
-- Equation(s):
-- \d_1|y~0_combout\ = ( \y[7]~input_o\ & ( \y[4]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[3]~input_o\ $ (!\y[1]~input_o\))) ) ) ) # ( !\y[7]~input_o\ & ( \y[4]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[3]~input_o\ $ 
-- (\y[1]~input_o\))) ) ) ) # ( \y[7]~input_o\ & ( !\y[4]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[3]~input_o\ $ (\y[1]~input_o\))) ) ) ) # ( !\y[7]~input_o\ & ( !\y[4]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[3]~input_o\ $ 
-- (!\y[1]~input_o\))) ) ) )
...
-- Equation(s):
-- \f_check~0_combout\ = ( \xorc00|y~combout\ & ( \m1isOne|m_Error|y~0_combout\ & ( !\xorc02|y~combout\ $ (!\xorc03|y~combout\ $ (!\xorc01|y~combout\)) ) ) ) # ( \xorc00|y~combout\ & ( !\m1isOne|m_Error|y~0_combout\ & ( (!\m2isOne|m_Error|y~0_combout\ & 
-- (!\xorc02|y~combout\ & (!\xorc03|y~combout\ & !\xorc01|y~combout\))) # (\m2isOne|m_Error|y~0_combout\ & (!\xorc02|y~combout\ $ (!\xorc03|y~combout\ $ (!\xorc01|y~combout\)))) ) ) ) # ( !\xorc00|y~combout\ & ( !\m1isOne|m_Error|y~0_combout\ & ( 
-- (!\m2isOne|m_Error|y~0_combout\ & (\xorc02|y~combout\ & (\xorc03|y~combout\ & \xorc01|y~combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000010110000010001010000000000000000001100001100111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \m2isOne|m_Error|ALT_INV_y~0_combout\,
...
\d_2|y~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \d_2|y~0_combout\ = ( \y[7]~input_o\ & ( \y[2]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[1]~input_o\ $ (!\y[3]~input_o\))) ) ) ) # ( !\y[7]~input_o\ & ( \y[2]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[1]~input_o\ $ 
-- (\y[3]~input_o\))) ) ) ) # ( \y[7]~input_o\ & ( !\y[2]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[1]~input_o\ $ (\y[3]~input_o\))) ) ) ) # ( !\y[7]~input_o\ & ( !\y[2]~input_o\ & ( !\y[6]~input_o\ $ (!\y[5]~input_o\ $ (!\y[1]~input_o\ $ 
-- (!\y[3]~input_o\))) ) ) )
...
PORT MAP (
	...
	combout => \d_2|y~0_combout\);

-- Location: LABCELL_X88_Y37_N24
\m3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \m3~0_combout\ = ( \d_2|y~0_combout\ & ( \y[0]~input_o\ & ( (!\m_2|y~combout\) # ((!\f_check~0_combout\) # (!\d_1|y~0_combout\ $ (!\m_1|y~combout\))) ) ) ) # ( !\d_2|y~0_combout\ & ( \y[0]~input_o\ & ( ((!\f_check~0_combout\) # (!\d_1|y~0_combout\ $ 
-- (!\m_1|y~combout\))) # (\m_2|y~combout\) ) ) ) # ( \d_2|y~0_combout\ & ( !\y[0]~input_o\ & ( (\m_2|y~combout\ & (\f_check~0_combout\ & (!\d_1|y~0_combout\ $ (\m_1|y~combout\)))) ) ) ) # ( !\d_2|y~0_combout\ & ( !\y[0]~input_o\ & ( (!\m_2|y~combout\ & 
-- (\f_check~0_combout\ & (!\d_1|y~0_combout\ $ (\m_1|y~combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000100000000010000001000000000111110111111111011111101111111110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \m_2|ALT_INV_y~combout\,
	datab => \d_1|ALT_INV_y~0_combout\,
	datac => \ALT_INV_f_check~0_combout\,
	datad => \m_1|ALT_INV_y~combout\,
	datae => \d_2|ALT_INV_y~0_combout\,
	dataf => \ALT_INV_y[0]~input_o\,
...
-- Equation(s):
-- \Cvalid|y~0_combout\ = ( \m1isOne|m_Error|y~0_combout\ ) # ( !\m1isOne|m_Error|y~0_combout\ & ( (\m2isOne|m_Error|y~0_combout\) # (\m0isOne|m_Error|y~0_combout\) ) )
