...
/**
 * General repository
 * It's responsible to keep an updated log of the game state aswell as the contestants,coaches and the referee states, having means to print the log to a file
 */
