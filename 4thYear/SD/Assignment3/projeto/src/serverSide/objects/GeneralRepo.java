...
public class GeneralRepo implements GeneralRepoInterface{
    ...
    */
     ...
     */
    @Override
    public synchronized void setOutcomeDetails(String outcomeDetails)throws RemoteException {
     ...
     */
    @Override
    public synchronized void setRefereeStateAndNumberGames(int state, int number_games)throws RemoteException {
        this.refereeState = state;
     ...
     */
    @Override
    public synchronized void setRefereeStateAndMatchWinner(int state, int matchWinner, int ScoreTeamID1, int ScoreTeamID2)throws RemoteException {
        refereeState = state;
     ...
     */
    @Override
    public synchronized void setPositionRope(int position_rope)throws RemoteException {
     ...
     */
    @Override
    public synchronized void set_nr_trials(int nr_trials)throws RemoteException {
     ...
     */
    @Override
    public synchronized void setCoachState(int coachID, int state)throws RemoteException {
     ...
     */
    @Override
    public synchronized void setContestantStateAndStrenght(int id, int state, int strength,int team)throws RemoteException {
