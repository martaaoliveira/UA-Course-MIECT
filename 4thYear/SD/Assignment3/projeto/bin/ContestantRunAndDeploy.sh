...
sshpass -f password ssh sd206@l040101-ws09.ua.pt 'cd test/TheRestaurant/dirChef ; unzip -uq genclass.zip'
sshpass -f password scp config sd206@l040101-ws09.ua.pt:test/TheRestaurant/dirContestants
