...
sshpass -f password ssh sd206@l040101-ws06.ua.pt 'cd test/TheRestaurant/dirGeneralRepo ; unzip -uq genclass.zip'
sshpass -f password scp config sd206@l040101-ws06.ua.pt:test/TheRestaurant/dirGeneralRepo
echo "Executing program at the server general repository."
sshpass -f password ssh sd206@l040101-ws06.ua.pt "cd test/TheGame/dirGeneralRepo ; java serverSide.main.ServerGeneralRepos 22253"
