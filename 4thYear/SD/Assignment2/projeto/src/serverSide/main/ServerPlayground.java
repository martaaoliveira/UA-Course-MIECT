...
public class ServerPlayground {
	...
	public static void main(String[] args) {
		...
		playgroundInterface playgroundInter; // interface to the barber shop
		...
		while (waitConnection) {
			try {
				...
				cliProxy = new PlaygroundClientProxy(sconi, playgroundInter); // start a service provider agent to address
