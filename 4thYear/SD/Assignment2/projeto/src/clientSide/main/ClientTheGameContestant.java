...
public class ClientTheGameContestant {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++)
			contestants[i] = new Contestant("Contestant_" + i, i, 1, strengthContestant[i], playgroundStub, benchtub, refereeSiteStub);

		for (int i = 5; i < 10; i++)
			contestants[i] = new Contestant("Contestant_" + i, i, 2, strengthContestant[i], playgroundStub, benchtub, refereeSiteStub);
