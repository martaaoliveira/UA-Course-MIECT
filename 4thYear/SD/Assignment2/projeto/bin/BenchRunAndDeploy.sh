...
sshpass -f password scp genclass.zip l040101-ws05.ua.pt:test/TheGame/dirBench
sshpass -f password ssh sd206@l040101-ws05.ua.pt 'cd test/TheGame/dirBench ; unzip -uq genclass.zip'
echo "Executing program at the Bench node."
sshpass -f password ssh sd206@l040101-ws05.ua.pt "cd test/TheGame/dirBench ; java serverSide.main.ServerBench 22252 l040101-ws06.ua.pt 22253"