...
while toc(t) < timeLimit
    ...
    [sol, load, Loads, energy] = GreedyRandomizedStrategy_Energy(nNodes, Links, T, sP, nSP, L, C, anyFlows);
    
    while energy == inf
        [sol, load, Loads, energy] = GreedyRandomizedStrategy_Energy(nNodes, Links, T, sP, nSP, L, C, anyFlows);
    end
        
    [sol, load, Loads, energy] = HillClimbingStrategy_Energy(nNodes, Links, T, sP, nSP, sol, load, Loads, energy, L, C);
