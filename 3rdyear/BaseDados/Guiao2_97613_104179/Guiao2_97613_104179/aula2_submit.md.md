...
Empresa, 
Produtos(código, nome, preço e taxa de Iva, número de unidades), 
Encomenda(número de encomenda,data realizada, unidades), 
Fornecedor(nome, número de informação fiscal, endereço, número de fax, condições de pagamento)
Tipo(Código interno e sua designação)

Relações:
| Entidade  |  Relação        | Entidade  |
| Empresa   |  comercializa   | produto   |
| Encomenda |   contém        | produto   |
| Empresa   |   fornece       | Fornecedor| 
...
Relações:
| Entidade  |            Relação         | Entidade  |
| Empresa   |    relação binária de 1:N  | produto   |
| Encomenda |    relação binária de N:N  | produto   |
| Empresa   |   relação binária de N:M   | Fornecedor| 
| Encomenda |    relação binária de N:1  | fornecedor|

-> Relação de obrigatoriedade da encomenda perante o produto (sem produtos não há encomenda)
-> Relação de obrigatoriedade da encomenda perante um fornecedor único (cada encomenda tem um fornecedor único)
-> relação de obrigatoriedade da empresa perante fornecedor e vice-versa ( se há empresa há fornecedor, e se há fornecedor existe empresa )
```
