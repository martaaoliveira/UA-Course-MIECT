...
GO
	...
	insert into PRESCRICAO_MEDICAMENTOS.MEDICO (NUMERO_IDENTIFICACAO, NOME, ESPECIALIDADE) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.PACIENTE (NUMERO_UTENTE, NOME, INFO_NASCIMENTO, ENDERECO) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.FARMACIA (NOME, TELEFONE, ENDERECO) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.FARMACEUTICA (NUMERO_REGISTO_NACIONAL, NOME, ENDERECO) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.FARMACO (NUMERO_REGISTO_NACIONAL_FARMACEUTICA, NOME_COMERCIAL, FORMULA) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.PRESCRICAO (NUMERO, NUM_UTENTE_PACIENTE, ID_MEDICO, NOME_FARMACIA, DATA_PROCESSAMENTO) values
	...
	insert into PRESCRICAO_MEDICAMENTOS.PRESC_FARMACO (NUM_PRESCRICAO, NUM_REGISTO_FARM, NOME_FARMACO) values	
