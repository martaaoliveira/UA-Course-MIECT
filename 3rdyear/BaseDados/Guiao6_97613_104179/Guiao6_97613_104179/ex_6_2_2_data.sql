...
insert into Modulo_Encomendas.TIPO_FORNECEDOR(
	Codigo, Designacao
) 
values
	(101,'Carnes'),
...
insert into Modulo_Encomendas.FORNECEDOR(
	NIF, nome, FAX, endereco, cond_pagamento, codigo_tipo_forn
)
values
...
insert into Modulo_Encomendas.PRODUTO(
	codigo, nome, preco, taxa_iva, unid_armazem
)
values
...
insert into Modulo_Encomendas.ENCOMENDA(
	numero, data_encomenda, NIF_fornecedor
)
values
...
insert into Modulo_Encomendas.ITEM(
