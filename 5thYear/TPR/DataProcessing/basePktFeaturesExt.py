...
# features é construído empilhando todas as estatísticas calculadas até agora 
# (média, mediana, desvio padrão) em um único array
...
def extractStatsAdv(data,threshold=0):
    ...
    features=np.hstack((M1,Md1,Std1,silence_faux,Pr1))
    return(features)
